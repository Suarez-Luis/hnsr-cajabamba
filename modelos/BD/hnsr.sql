...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-12-2020 a las 17:57:45
...
INSERT INTO `atencion` (`id_atencion`, `codigo_atencion`, `id_usuario`, `id_personal_salud`, `id_paciente`, `ups`, `servicio`, `especialidad`, `diagnostico`, `imagen_diagnostico`, `imagen_diagnostico2`, `imagen_diagnostico3`, `imagen_diagnostico4`, `fecha_atencion`, `fecha`) VALUES
...
(9, 'Luis', 'Suárez', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 'vistas/img/usuarios/admin/687.jpg', 1, '2020-12-10 09:39:10', '2020-12-10 14:39:10'),
...
--
ALTER TABLE `atencion`
  MODIFY `id_atencion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `personal_salud`
  MODIFY `id_personal_salud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
